...
trait HasTeamsNoPersonal
{
    ...
    public function currentTeam()
    {
        if (is_null($this->current_team_id) && $this->id) {
            // Find the first team the user is part of instead of creating a personal team
            $firstTeam = $this->allTeams()->first();
    
            if ($firstTeam) {
                $this->switchTeam($firstTeam);
            }
            // IMPORTANT: DO NOT return here. Fall through to return the BelongsTo relationship.
        }
    
        // ALWAYS return the relationship instance as the Eloquent class expects it.
